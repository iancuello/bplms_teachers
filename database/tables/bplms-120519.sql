...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 06, 2019 at 05:50 AM
...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  `countries_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `countries` (`countries_id`, `countries_code`, `countries_name`, `created_at`, `updated_at`) VALUES
...
(204, 'SR', 'Suricountries_name', NULL, NULL),
...
(11, '2019_11_05_235443_create_teachers_profiles_table', 1),
(12, '2019_11_07_210154_create_countries_table', 1);
...
DROP TABLE IF EXISTS `teachers_profiles`;
CREATE TABLE IF NOT EXISTS `teachers_profiles` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `teachers_profiles_usersid_unique` (`usersid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
