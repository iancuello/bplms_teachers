			...
			<div class="kt-login__container">
				...
				<div class="kt-login__signin">
                    ...
                    <form class="kt-login__form kt-form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
						<div class="input-group">
                            <input id="name" type="text" placeholder="Username" name="name" value="{{ old('name') }}" 
                            class="{{ $errors->has('name') ? 'form-control is-invalid' : 'form-control'}}" 
                            aria-describedby="{{ $errors->has('name') ? 'name-error' : ''}}" required autofocus>
                                @if ($errors->has('name'))
						...
						<div class="input-group">
                            ...
                            aria-describedby="{{ $errors->has('email') ? 'email-error' : ''}}" required>
                                @if ($errors->has('email'))
                        ...
                        <div class="input-group">
                            ...
                            aria-describedby="{{ $errors->has('password') ? 'password-error' : ''}}" required>
						...
						<div class="kt-login__actions">
							<button id="" class="btn btn-pill kt-login__btn-primary">Sign Up</button>&nbsp;&nbsp;
							<button id="kt_login_signup_cancel1" class="btn btn-pill kt-login__btn-secondary" onclick="{{ route('login') }}">Cancel</button>
						</div>
					</form>
				</div>
