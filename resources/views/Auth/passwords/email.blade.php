				...
				<div class="login__signin">
                    ...
                    <form class="kt-form" method="POST" action="{{ route('password.email') }}">
                         ...
                         <div class="input-group">
                                <input id="email" type="text" placeholder="Email" name="email" autocomplete="off" value="{{ old('name') }}" 
						...
						<div class="kt-login__actions">
							<button id="kt_login_forgot_submit1" class="btn btn-pill kt-login__btn-primary">Send Password Reset Link</button>&nbsp;&nbsp;
							<button id="kt_login_forgot_cancel1" class="btn btn-pill kt-login__btn-secondary">Cancel</button>
						</div>
					</form>
				</div>
